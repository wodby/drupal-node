...
docker-compose exec drupal apk add --update jq
docker-compose exec --user=82 drupal make init -f /usr/local/bin/actions.mk
docker-compose exec --user=82 drupal tests.sh
#docker-compose down
